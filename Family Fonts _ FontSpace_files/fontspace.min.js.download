try {
	...
	(function(win, document) {
		...
		var last_release_ts = "2023-04-20 09:38:35";  // Last time a file was released from split test
		...
		// List of rtp files
		var rtp_files = {"21569":"latest","21570":"2.38.1"};

		// List of custom tags
		var rtp_default_tags = {"Flex":["21569"],"Main":["21570"]};

		// Traffic Percentages
		var traffic_percentages = {"21569":0,"21570":1};
...
window.properSpecialOps.region='MP';
